# -- Step 1: Require Administrator Privileges (single line for iex compat) --
...
$files = @("Configuration.xml", "configuration-Office365-x64.xml", "officedeploymenttool_19725-20126.exe", "setup.exe")
...
if (Test-Path $setupPath) {
    ...
    Start-Process "cmd.exe" -ArgumentList "/K $cmd" -Verb RunAs -WorkingDirectory $dirPath
} else {
